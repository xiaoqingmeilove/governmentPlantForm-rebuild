...
global.$mqtt = new mosca.Server(settings);
$mqtt.on('ready', ()=>{console.log("mqtt开始启动")});
...
var synchrodata = require('./api/synchrodata.js')//拉取所有城市电梯的数据
server.get('/api/zaixian', async function(req, res){
    synchrodata.default(res)
})  
